...
- full range — **scans 231–262 / printed pp.230–261 / 32 pages**
- Gate C — **COMPLETE**
- Gate C.5 — **N/A / CLOSED**
...
## Controlling source for this batch
...
1. compare each transcript page word-for-word against its controlling scan pixels;
