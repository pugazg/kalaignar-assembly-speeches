...
- publication/imprint — `சென்னை 21-7-1971`
...
- scan 1 — front cover
- scan 2 — title / portrait page
- scan 3 — publication introduction / imprint
- scans 4–60 — continuous `நமது விளக்கம்` body
- scan 61 — back cover

Body pagination:

- scan 5 = printed p.4
- scans 5–60 follow `printed = scan - 1`
- scan 4 = implied printed p.3
- body range = **implied printed pp.3–59 / 57 pages**
...
Source-internal event evidence from scan 3:

- 29-6-1971 — Legislative Assembly budget-debate reply
- 30-6-1971 — Legislative Council budget-debate reply

The booklet body itself has one continuous printed unit and no securely printed internal House divider. Do **not** invent Assembly/Council scan ranges. Preserve the booklet as an edited two-House compilation.

Reader-facing entry:

`speeches/1971/1971-namathu-vilakkam/`

This entry has `date: null` and is not placed in `data/speeches.json` or the canonical dated speech table.

## Historical-print rule

Gate C.5 is mandatory.
...
- printed pages — **23–32**
- pages transcribed — **10**
- cumulative Gate C — **30/57**
- source markers — **4→33 exactly once / monotonic**
- new unresolved readings — **1**
- cumulative unresolved readings — **2**
- new unresolved location — scan **31** / printed p.30, classroom-anecdote object phrase
- existing unresolved location — scan **11** / printed p.10
- Gate C.5 — **NOT STARTED**
- Tamil verified — **false**
- English — **BLOCKED**
...
- printed pages — **43–52**
- pages transcribed — **10**
- cumulative Gate C — **50/57**
- source markers — **4→53 exactly once / monotonic**
- source-printed English — scans **44, 46, 47, 48** preserved verbatim
- scan 47 visible clipping `nd encouraged.` — deliberately not reconstructed
- new unresolved readings — **0**
- cumulative unresolved readings — **3**
- unresolved locations — scans **11, 31, 37**
- illustration/context notes — scans **44, 47, 52**
- Gate C.5 — **NOT STARTED**
- Tamil verified — **false**
- English — **BLOCKED**
...
- unresolved source-fidelity questions — **0**
- page joins — **9/9 PASS**
- boundary dash repairs — **15→16, 16→17, 19→20, 22→23**
...
- scans — **4–13 / implied printed pp.3–12**
- pages reviewed — **10 / cumulative 10/57**
- English fidelity refinements — **5**
- blocking fidelity issues — **0**
- verified Tamil changes — **none**
- source-page order / headings / scan-11 intervention / canonical emendation / figures / illustration notes — **PASS**
