...
- source pixels remain the final authority for source-layer questions
...
**Do not enter Unit 2 while Unit 1 Gates F–H remain open.**
...
Scan 13 also contains smaller cartoon labels that remain intentionally unresolved.

These known source losses do **not** invalidate the verified status of the visible source layer.
