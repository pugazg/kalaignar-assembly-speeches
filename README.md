...
- [`நமது விளக்கம்` — 1971 source package](./sources/1971-namathu-vilakkam/README.md) — 61-scan Government of Tamil Nadu booklet. **Gate A–F PASS / COMPLETE. Tamil is VERIFIED 57/57; English first pass is COMPLETE 57/57. Gate G is IN PROGRESS: G1–G5 scans 4–53 COMPLETE, 50/57 pages reviewed, 35 cumulative English fidelity refinements, 0 blocking issues, no verified-Tamil changes and no outside wording used. Exact next is Gate G G6 / FINAL scans 54–60; Gate H remains blocked.**
