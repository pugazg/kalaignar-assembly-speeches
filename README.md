...
- [`நிதிநிலை அறிக்கை மீது கலைஞரின் சட்டமன்ற உரைகள் (பாகம் - 1)` — 2007 source package](./sources/2007-financial-statement-speeches-part-1/README.md) — **546-scan anthology; Gate A + Gate B COMPLETE / LOCKED; 19 speech units mapped. Speeches 1–14 are RELEASED / CLOSED through Gate H with verified Tamil and verified English.** Speech 12 / 07.03.1973 is a separately released independent parallel witness at [`1973-03-07-financial-statement-debate`](./speeches/1973/1973-03-07-financial-statement-debate/): **Gate H PASS / COMPLETE; canonical bilingual transcript COMPLETE; 0 Tamil / 0 English Gate-H wording changes**. The separately released `1973-03-07-financial-statement-reply` remains unchanged. To avoid a second canonical same-date record, the dated speech table and `data/speeches.json` intentionally retain only the existing reply entry; the anthology witness remains discoverable through the source package and repository status sections. Speech 13 / 14.03.1974 and Speech 14 / 10.03.1975 are RELEASED / CLOSED through Gate H. Speech 15 / 03.08.1977 Gate C is COMPLETE at 36/36 first-pass pages, Gate C.5 is N/A / CLOSED, and Gate D is PASS / COMPLETE with markers 320→355 exactly once and ordered, 0 missing/duplicate/empty page sections, locked boundaries and split continuations passing, intervention pages 326/335/343/349 represented, and 0 completeness corrections. Gate E is IN PROGRESS: Batches 1–3 are PASS / COMPLETE through scan 349 at 30 of 36 pages, with 51 cumulative source-backed correction entries / 51 occurrences, 24 affected scans, and 0 unresolved readings. Tamil remains NOT VERIFIED / verified_against_scan=false. Repository rule: Gate C and Gate E use 10 source pages per iteration. Exact next: Speech 15 Gate E FINAL Batch 4 — scans 350–355 / 6-page final remainder.
