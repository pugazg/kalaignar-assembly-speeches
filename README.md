...
- [`இருளும் ஒளியும்` — 1973 source package](./sources/1973-irulum-oliyum/mapping.md) — 64-scan Government of Tamil Nadu publication mapped into an Assembly reply on 7-3-1973 and a Legislative Council reply on 8-3-1973. **Unit 1 crop recovery and revalidation are complete: Tamil and English are verified again, post-recovery Gate H passed, and the 7-3-1973 Assembly reply is RELEASED. Unit 2 Gate D is in progress: D1+D2 scans 41–60 / printed pp.40–59 PASS, with 2 cumulative source-context completeness corrections and 0 unresolved; exact next activity is D3 / FINAL scans 61–62 / printed pp.60–61.**
