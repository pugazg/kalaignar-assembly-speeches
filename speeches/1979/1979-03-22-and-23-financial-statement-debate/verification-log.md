# Verification log — உரை : 17 / 22 & 23.3.1979

## Source-boundary + date-policy setup

**PASS / COMPLETE.**

- incoming boundary **388→389** — **PASS**
- outgoing boundary **481→482** — **PASS**
- mapped speech range — **389–481 / 93 pages**
- printed range — **388–480**
- source label — **உரை : 17 / 22 & 23.3.1979**
- full-range internal-date review — **COMPLETE**
- explicit internal date divider — **NOT FOUND**
- single canonical date — **NOT ASSIGNED**
- source-unit treatment — **one continuous multi-date unit**
- outside witnesses consulted for wording/date assignment — **0**

## Gate C Batch 1

**COMPLETE — scans 389–398 / 10 of 93 pages.**

Checks:

- source-page markers **389→398** — **10/10 / exactly once / ordered**
- controlling source — **part016 local pages 14–23**
...
- scans 399–481 — **untouched**

Source-visible forms intentionally retained for later Gate-E fidelity verification:
...
**COMPLETE — scans 419–428 / 10 pages; cumulative 40 of 93.**

Checks:

- source-page markers **419→428** — **10/10 / exactly once / ordered**
- cumulative source-page markers **389→428** — **40/40 / exactly once / ordered**
- controlling source — **part017 local 19–25 + part018 local 1–3**
...
**COMPLETE — scans 469–478 / 10 pages; cumulative 90 of 93.**

Checks:

- source-page markers **469→478** — **10/10 / exactly once / ordered**
- cumulative source-page markers **389→478** — **90/90 / exactly once / ordered**
- controlling source — **part019 local 19–25 + part020 local 1–3**
- split transition **475→476** — **PASS / continuous**
- first-pass unresolved readings — **0**
- source-printed English `They are stopped.` on scan **474** — **preserved**
- source procedural/header material on scan **477** — **preserved**
- outside wording imported — **0**
- OCR wording imported — **0**
- web wording imported — **0**
- Official Report / alternate anthology wording imported — **0**
- verified against scan — **false; Gate C is first-pass transcription, not verification**
- scans 479–481 — **untouched**
...
1. **scan 396 / printed p.395** — `படித்த, படிக்காத, வேலையில்லாத அனைவருக்கும் வேலை வாய்ப்பு` → `படித்த, படிக்காத, வேலை யில்லாத அனைவருக்கும் வேலை வாய்ப்பு`
   - the source visibly prints `வேலை யில்லாத`.
...
- Batch 1 exact-next handoff — **Gate G Batch 2 — scans 419–448 / exactly 30 pages / now completed**
