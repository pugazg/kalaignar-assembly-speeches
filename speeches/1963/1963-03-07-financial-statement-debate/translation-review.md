# Translation review — உரை : 6 / 7.3.1963
...
- source-page sequence **60→75**;
- the opening M. Bhaktavatsalam intervention on scan 60;
- the Finance Minister quotation across scans 61→62 and the source's defence/development argument;
- all tax arguments, the smallpox/needle image, the 25 July 1957 plantation-income-tax reference, **45 / 50 paise**, and the Mada Gowder quotation;
- the husband-and-wife tax anecdote and the Khrushchev quotation across scans 64→65;
- the public/private-sector industry lists, the **Avadi socialism** reference, roughly **5,000 buses / 200+ motor magnates**, and the two C. P. Ramaswami Aiyar quotations;
- the Madras taxi passage, **50 / 100 hire cars**, the source-bound **Keevaraj** rendering, and the blackleg-work argument;
- Japan's **60 lakh farmers**, agriculture/seed-distribution discussion, village assistance groups and B.A./M.A. cooking analogy;
- the Katpadi “phantom orchard”, **Rs.6,000** bee-farm/Panchayat Union figure and agriculture-through-music research;
- D. C. S. Singh, Charukesi/nadaswaram trials and every percentage/quantity reported in scans 70–72, including **25–60%, 45%, 66%, 50–60%, 8–57%, 10–83%, 5.48 inches and 8 tons per acre**;
- the source place names and research references, including **Aften Posten**, Prithvi Trust/Prize, **Rs.2,000**, gold medal and **‘Man of Philosophy’**;
- the Nehru/Agriculture Department passage and the K. Kamaraj intervention on scan 72;
- Salem steel, Tuticorin deep-sea and Sethusamudram passages, including the **500-mile** reference;
- sugar-production figures **311 / 321 / 888 / 74 thousand tons** and the Dr. P. Natarajan quotations/pages **196 / 174**;
- the source-printed English Speaker sentences on scan 73 **verbatim**:
  - `The Hon. Member has already taken 25 minutes.`
  - `Then it will be against the rules and regulations.`
- the **four-crore-rupee** Central Government passage, Shankar Das Banerjee / P. C. Roy references and wrestler analogy;
- the goldsmiths/swimming image and the Kamaraj biographical anecdote through the scan-75 close;
- all source-era political, economic and historical claims without outside correction.

Conservative source-bound handling:

- `மாதா கவுடர்` → **Mada Gowder**, without outside identity correction;
- `கீவராஜ்` → **Keevaraj**, without outside identification;
- `பொறுக்குவிதை` → **selected seed**, from the verified Tamil context;
- `கருங்காலி வேலை` → **blackleg work**, preserving the strikebreaking sense in the speech;
- `குதிரைவாலி சம்பா` → **Kuthiraivaali Samba**, without importing a botanical gloss;
- source place/company spellings are rendered conservatively from the verified Tamil where the source itself does not print English.
