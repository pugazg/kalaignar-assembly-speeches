...
The canonical Tamil layer is now source-verified again. The canonical English below it is still the **pre-recovery Gate-G-verified translation** and is not synchronized with the newly recovered Tamil. Current English legacy crop markers on the 11 recovered source-page sections total **249** and must be repaired from the final Gate-E-verified Tamil before Gate G and Gate H can be re-run.

**Exact next activity: English repair / retranslation for recovered spans on scans 4–5, 10–11, 20–21, 25–27 and 34–35 only.** Do not run Gate G or Gate H in the same iteration. Unit 2 Gate D D1 remains paused.
