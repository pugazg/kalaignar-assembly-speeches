...
The controlling scan has gutter-edge loss on scans 4–5, 10–11, 20–21, 25–27 and 34–35. A newly supplied official **Tamil Nadu Legislative Assembly Debates, 7 March 1973** volume now provides an independent primary-source witness for the same speech. **CR1 bulk-populated scans 4–5 and 10–11, removing 99 legacy literal crop-marker occurrences without contextual guessing; all four bulk-CR1 pages are now individually page-level revalidated.** Scans **20–21** are now additionally recovered and individually revalidated. Remaining crop holds are scans **25–27 and 34–35**. Scan p.13 also contains small cartoon labels that remain explicitly unresolved where the scan does not support a confident reading. Scans 14–19, 22–24, 28–33 and 36–40 introduce no comparable crop loss; printed English passages are preserved in the Tamil source layer as printed. Printed illustration/cartoon labels are represented only where the scan supports a confident reading.
...
Crop recovery is now being revalidated **page by page**. Booklet scans **4–5, 10–11 and 20–21 / printed pp.3–4, 9–10 and 19–20 are PASS / VERIFIED**. Scan 21 revalidated **28 line-level left-gutter positions** (legacy literal count 29 includes one explanatory token), required only **1** official-witness-supplied missing fragment, and confirmed **27** positions need no inserted text. The pass also corrected two source-visible fidelity issues: `டிப்பட்டு` → `அடிபட்டு`, and the quotation around `அன் அக்கெளண்டட் மணி` to the booklet's double quotation marks. All physical line breaks, the `வரி ஏய்ப்பு` illustration label, and the scan-21→22 cross-page `கட்டுப்படுத்துகின்ற` boundary are preserved. Scan 21 now has **0 source-loss markers remaining** and **0 contextual guesses**. **Exact next activity: scan 25 / printed p.24 only.** Unit 2 Gate D D1 remains paused until this recovery/revalidation sequence is complete.
