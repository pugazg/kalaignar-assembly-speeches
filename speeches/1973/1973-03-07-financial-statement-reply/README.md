...
Crop recovery page-level revalidation is now **COMPLETE**. Booklet scans **4–5, 10–11, 20–21, 25–27 and 34–35 / printed pp.3–4, 9–10, 19–20, 24–26 and 33–34 are PASS / VERIFIED**. Final scan 35 revalidated **36 line-level left-gutter positions** (legacy literal count 37 includes one explanatory token), restored **2** source-supported missing fragments — initial `1` in `1,41,000` and concluding `ஆக,` before `ஒரு இலட்சத்து 57 ஆயிரம்...` — and confirmed **34** positions need no inserted text. The generator/licence exchange, `குடியிருப்பு மனைப்பட்டா` section, all dates/figures, physical lineation, scan-34→35 continuation and scan-35→36 boundary were checked against TNLA pp.112–113 / proceedings pp.510–511 without normalizing booklet-visible wording. Scan 35 now has **0 source-loss markers remaining** and **0 contextual guesses**. **Exact next activity: whole-Tamil crop-recovery integrity audit across scans 4–40.** Do not begin Gate-E recheck until that integrity audit passes. Unit 2 Gate D D1 remains paused.
