...
The controlling scan has gutter-edge loss on scans 4–5, 10–11, 20–21, 25–27 and 34–35. A newly supplied official **Tamil Nadu Legislative Assembly Debates, 7 March 1973** volume now provides an independent primary-source witness for the same speech. **CR1 bulk-populated scans 4–5 and 10–11, removing 99 legacy literal crop-marker occurrences without contextual guessing; all four bulk-CR1 pages are now individually page-level revalidated.** Scans **20–21, 25–27 and 34** are now additionally recovered and individually revalidated. The only remaining crop hold is scan **35**. Scan p.13 also contains small cartoon labels that remain explicitly unresolved where the scan does not support a confident reading. Scans 14–19, 22–24, 28–33 and 36–40 introduce no comparable crop loss; printed English passages are preserved in the Tamil source layer as printed. Printed illustration/cartoon labels are represented only where the scan supports a confident reading.
...
Crop recovery is now being revalidated **page by page**. Booklet scans **4–5, 10–11, 20–21, 25–27 and 34 / printed pp.3–4, 9–10, 19–20, 24–26 and 33 are PASS / VERIFIED**. Scan 34 revalidated **5 line-level right-gutter positions** (legacy literal count 6 includes one explanatory token), restored **2** source-supported items — the period after `லைசென்ஸ் வழங்கப்படவில்லை` and the final `ர்` in `முதல் அமைச்சர்` — and confirmed **3** positions need no inserted text. Booklet-visible `லைசென்ஸ்` and `வந்து` were retained even though the TNLA witness differs. The Ananthanayaki / Hande exchange, generator/licence response, physical lineation, and scan-34→35 `... நாங்கள் / செலவு செய்துவிட்ட...` continuation were verified. Scan 34 now has **0 source-loss markers remaining** and **0 contextual guesses**. **Exact next activity: scan 35 / printed p.34 only.** Unit 2 Gate D D1 remains paused.
