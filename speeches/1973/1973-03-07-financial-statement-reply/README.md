...
The controlling scan has gutter-edge loss on scans 4–5, 10–11, 20–21, 25–27 and 34–35. A newly supplied official **Tamil Nadu Legislative Assembly Debates, 7 March 1973** volume now provides an independent primary-source witness for the same speech. **CR1 bulk-populated scans 4–5 and 10–11, removing 99 legacy literal crop-marker occurrences without contextual guessing; all four bulk-CR1 pages are now individually page-level revalidated.** Scans **20–21 and 25** are now additionally recovered and individually revalidated. Remaining crop holds are scans **26–27 and 34–35**. Scan p.13 also contains small cartoon labels that remain explicitly unresolved where the scan does not support a confident reading. Scans 14–19, 22–24, 28–33 and 36–40 introduce no comparable crop loss; printed English passages are preserved in the Tamil source layer as printed. Printed illustration/cartoon labels are represented only where the scan supports a confident reading.
...
Crop recovery is now being revalidated **page by page**. Booklet scans **4–5, 10–11, 20–21 and 25 / printed pp.3–4, 9–10, 19–20 and 24 are PASS / VERIFIED**. Scan 25 revalidated **37 line-level left-gutter positions** (legacy literal count 38 includes one explanatory token), restored **4** missing characters/punctuation marks — initial `எ` in `எடுத்துக்கொண்டால்`, opening parentheses in `(1)` and `(3)`, and English `h` in `have been` — and confirmed **33** positions need no inserted text. The **60 / 130 / 90 / 280 / 225** electricity-demand figures, **6 இலட்சம்** pump connections, **71/72/73** project years, **1,035 மெகாவாட்** total, ten-project list, Ananthanayaki English intervention and scan-25→26 `உட்படுத்தப்பட்டிருக் / கிறதா?` boundary were checked. Scan 25 now has **0 source-loss markers remaining**, **0 contextual guesses**, and no additional non-crop fidelity correction. **Exact next activity: scan 26 / printed p.25 only.** Unit 2 Gate D D1 remains paused until this recovery/revalidation sequence is complete.
