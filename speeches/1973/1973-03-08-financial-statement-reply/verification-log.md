...
### Batch C1 — scan pp.41–50 / printed pp.40–49

- first-pass transcription completed for **10 scans**, 41–50, directly from the rendered controlling source;
- source-page markers **41→50** are present exactly once and in order;
- scan p.41 begins the locked Unit-2 heading `சட்டமன்ற மேலவையில்`;
- headings and parliamentary interventions were retained in source order;
- no comparable physical gutter-edge crop loss was identified in scans 41–50, so C1 introduces **0 `⟦scan-crop⟧` holds**;
- illustrations on scans 43–44 were preserved as source context without inventing unreadable labels;
- scan p.50 source-printed Punjab Electricity Board English is retained verbatim, including the two quoted passages;
- figures, dates and source-supported oddities were not fact-corrected or normalized;
- formal historical-glyph checking has **not** started; Gate C.5 remains mandatory after all 22 Unit-2 scans are transcribed;
- Gate D/E verification has **not** started;
- `transcription.verified_against_scan=false`;
- English translation remains blocked;
- released Unit 1 was not modified.
