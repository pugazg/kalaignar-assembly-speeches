# Source notes — உரை : 10 / 23.08.2006

## Authority

The controlling source is the rendered scan of `தொழில்துறை பற்றி கலைஞரின் சட்டமன்ற உரைகள்`, first edition May 2007. OCR or parsed text may assist but does not override the scan image.

Locked source fingerprint from anthology mapping: 329 PDF pages; 217,124,211 bytes; SHA-256 `c26003fe77b97adc6487ba0e4c00c9fa34a0a53839aa326d3ef5897f8616d370`.

## Locked Speech-10 mapping
...
- p.303 closes Speech 9
- p.304 begins Speech 10
- p.326 closes Speech 10
- pp.327–328 are `குறிப்புகள்`; p.329 is closing portrait/back matter
