# English translation — உரை : 10 / 23.08.2006

> **Gate F working translation note:** This English rendering is translated only from the final Gate-E-verified Tamil. Kalaignar's parliamentary voice is to be retained: argumentative sequence, repetition, direct address, humour, wordplay, irony, metaphors, register shifts and stage markers are preserved rather than rewritten into generic modern English. Printed English in the Tamil source is retained as printed. Source claims and figures are not externally corrected. This is a working Gate-F translation and is **not yet Gate-G verified**.
...
The funds required for all these will be mobilised through share investments, through Share Capital, and through borrowings. The amount to be provided through share investment — Equity — will be only a small portion. TIDCO will undertake this in order to implement these projects. The major portion of the funds required will be obtained as loans from banks and financial institutions. Generally, for all projects of this kind, it is by this method that financial—
...
Here, under these two headings — the Industries Department and the Information Technology Department — altogether 285 cut motions have been submitted. I too have been in this House since 1957. The Professor too was with me in 1957. Afterwards he went to Parliament and came back here. Continuously from 1957 until now, I have been here. So many cut motions—

> **Gate G Batch 1 note:** Source pp.304–308 were reviewed against the final verified Tamil. Two definite fidelity corrections were applied: on p.304, the English now preserves the personal referent in `அவரை ... கேலியாகவோ, கிண்டலாகவோ, வசையாகவோ` instead of changing it into the impersonal “all that”; on p.307, `ஈவுத் தொகை, Equity` is no longer mistranslated as a “dividend component” and is rendered as the amount provided through share investment — Equity. The stumble/music wordplay, temporary-weakness passage, போட்டாபோட்டி/காட்டாங்குஸ்தி sequence, வம்பு repetition, newspaper-headline tease, `surrender` joke, statistics, printed English and Sudarsanam humour were otherwise retained. English is not fully verified until all 23 pages pass Gate G.
